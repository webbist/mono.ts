...
namespace System.Security.Claims {
    ...
    export class ClaimsIdentity implements System.Security.Principal.IIdentity {
        ...
        constructor(identity: System.Security.Principal.IIdentity, claims: Claim[])
        constructor(identity: System.Security.Principal.IIdentity, claims: Claim[], authenticationType: string, nameType: string, roleType: string)
    ...
    export class ClaimsPrincipal implements System.Security.Principal.IPrincipal {
        private _claimsIdentities: ClaimsIdentity[];

        get Identity(): System.Security.Principal.IIdentity {
